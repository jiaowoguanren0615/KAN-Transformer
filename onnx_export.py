...
parser.add_argument('--model', default='kat_tiny_gelu_patch16_224', type=str, metavar='MODEL',
                    choices=['kat_tiny_gelu_patch16_224', 'kat_tiny_swish_patch16_224', 'kat_tiny_patch16_224',
                             'kat_small_swish_patch16_224', 'kat_base_swish_patch16_224', 'kat_base_patch16_224',
                             'kat_small_patch16_224', 'kat_base_gelu_patch16_224', 'kat_small_gelu_patch16_224'
                             ],
                    help='model architecture (default: kat_tiny_gelu_patch16_224)')
parser.add_argument('--checkpoint', default='./output/kat_tiny_gelu_patch16_224_best_checkpoint.pth', type=str, metavar='PATH',
