<h1 align='center'>KANTransformer</h1>

### This is a warehouse for KANTransformer-Pytorch-model, can be used to train your image-datasets for vision tasks.  


## For segmentation tasks, please refer this [github warehouse](https://github.com/jiaowoguanren0615/Segmentation_Factory/blob/main/models/backbones/kantransformer.py)  


### [Kolmogorov-Arnold Transformer](https://arxiv.org/abs/2409.10594)  

![image](https://github.com/Adamdad/kat/blob/main/assets/kat3-1.png)  
...
├── models: VisionTransformer Model
    ├── build_models.py: Construct KANVisionTransformer models
├── scheduler:
...
├── util:
    ...
    ├── validate.py: Image dataset validation processing
...
```bash
python onnx_export.py --model=kat_tiny_gelu_patch16_224 --output=./kat_tiny_gelu_patch16_224.onnx --checkpoint=./output/vit_base_patch16_224_best_checkpoint.pth
```

### step2: ONNX optimise
```bash
python onnx_optimise.py --model=kat_tiny_gelu_patch16_224 --output=./kat_tiny_gelu_patch16_224_optim.onnx
```

### step3: ONNX validate (modify the param of ___data_root___ and ___onnx-input___)  
```bash
python onnx_validate.py --data_root=/mnt/d/flower_data --onnx-input=./kat_tiny_gelu_patch16_224_optim.onnx
```
